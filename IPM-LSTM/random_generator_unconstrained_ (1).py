...
# probs = [0, 0, 1, 0]                    # lower, upper, both, partial
...
num_ineq = 0
num_eq = 0
out_path = 'datasets/qp/QP_convex_10var_0eq_0ineq_new.mat'
os.makedirs(os.path.dirname(out_path), exist_ok=True)
...
# Box-bound scheme probabilities: ['lower','upper','both','partial']
box_probs = [0, 0, 1, 0]  # always 'both' in this config; change as desired
...
box_types = rng.choice(['lower', 'upper', 'both', 'partial'], size=N, p=box_probs)
